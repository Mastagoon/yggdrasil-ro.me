    ...
    <section id="download-section">
        <div class="logo">
            <img src="/imgs/logo.png" alt="" class="logo-download" />
        </div>
        <h2>تحميل اللعبة</h2>
        <p>للبدء في اللعب مباشرةً, كل ماعليك فعله هو تحميل ملفات اللعبة</p>
        <div class="download-links">
            <a href="#" class="download-link direct"><i class="fa fa-download"></i>Direct</a
        >
        <a href="#" class="download-link mediafire"
          ><i class="fa fa-fire"></i>MediaFire</a
        >
      </div>
      <hr />
      <p>الباتشر الخفيف (لا ينصح به)</p>
      <div class="download-links">
        <a href="#" class="download-link direct"
          ><i class="fa fa-download"></i>Direct</a
        >
        <a href="#" class="download-link mediafire"
          ><i class="fa fa-fire"></i> MediaFire</a
        >
    ...
    <footer>
      <div class="container">
        <div class="right-section">
          <p>Designed By: Mastagoon</p>
          <p>جميع الحقوق محفوظة</p>
          <p>YggdrasilRO©2020</p>
        </div>
        <div class="left-section">
          <div class="download-btn-footer">
            <a href="#" class="btn-download">حمل الآن</a>
        </div>
        <div class="footer-icons">
            <a href="https://discord.gg/p5ZZbvm"><i class="fab fa-2x fa-discord" aria-hidden="true"></i
            ></a>
            <a href="#"><i class="fab fa-2x fa-facebook" aria-hidden="true"></i
            ></a>
            <a href="https://github.com/mastagoon"><i class="fab fa-2x fa-github" aria-hidden="true"></i
            ></a>
        </div>
        </div>
        </div>
